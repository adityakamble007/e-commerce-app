        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
            ...
            <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    {/* Header Skeleton */}
                    <div className="mb-8">
                        <div className="h-10 bg-gray-200 dark:bg-gray-800 rounded-lg w-40 mb-4 animate-pulse" />
                        <div className="flex items-center gap-2">
                            <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-12 animate-pulse" />
                            <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-4 animate-pulse" />
                            <div className="h-4 bg-violet-200 dark:bg-violet-800 rounded w-16 animate-pulse" />
                        </div>
                    </div>
