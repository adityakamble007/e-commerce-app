...
export default function Home() {
  // Memoize static product data to prevent recreation on every render
  const featuredProducts = useMemo(
    () => [
      ...
      },
      {
        ...
        description:
          "Handcrafted genuine leather with laptop compartment",
        rating: 4.9,
        reviews: 312,
        badge: "20% OFF",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed">
              ...
              From the latest tech to timeless fashion, find
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              ...
              <Button
                variant="outline"
                className="px-8 py-6 text-lg rounded-xl border-2 border-gray-300 dark:border-gray-700 hover:border-violet-500 dark:hover:border-violet-500 transition-all duration-300"
              >
                View Collections
              </Button>
            </div>
